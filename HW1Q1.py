...
plt.tight_layout()
plt.savefig('../hw1/Q1A_perror.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('../hw1/Q1B_perror.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('../hw1/Q1C_perror.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('../hw1/Q1_roccmp1.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('../hw1/Q1_perrcmp1.pdf')
plt.show()
